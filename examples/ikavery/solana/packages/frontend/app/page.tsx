					...
					<div className="col-span-12 lg:col-span-7 lg:order-1">
						...
						<Reveal delay={0.22}>
							<p className="mt-6 sm:mt-7 max-w-[480px] text-[15px] sm:text-[17px] leading-[1.6] text-text-2">
								...
								<span className="text-text">Solana</span>. Splits a private key across the wallets
								of the people you already trust, lets any quorum sign on demand. Runs on{' '}
								<span className="text-text">Ika 2PC-MPC</span>. The purpose is to show, not to ship.
							</p>
						</Reveal>
						<Reveal delay={0.34}>
...
const vault = await importSolanaKey({
  ...
  threshold: { k: 3, of: 5 },
						...
						<div className="flex items-center justify-between px-6 py-3 border-t border-border bg-surface-3/30">
							...
							<code className="font-mono text-[11.5px] text-clay">7QKFYi…SStkF</code>
						</div>
					</Tile>
					...
					<Tile span={{ col: 2 }}>
						...
						<div className="font-display text-[32px] leading-[1.05] tracking-[-0.02em] text-text">
							<span className="text-text-3 italic">None.</span> The Solana program verifies a wallet
							signature directly, on-chain.
						</div>
						<div className="mt-4 font-mono text-[12px] text-clay">ikavery::approve</div>
					</Tile>
				</div>
			</section>
