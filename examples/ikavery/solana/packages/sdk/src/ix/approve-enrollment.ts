...
export function buildApproveEnrollmentIx(params: ApproveEnrollmentParams): ApproveEnrollmentIx {
	const memberIdHashAddress = memberIdHash(params.memberSlot);
	const approval = enrollmentApprovalPda(params.enrollment, memberIdHashAddress);
