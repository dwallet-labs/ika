...
import { Code2, Layers, BookOpen, Terminal, Puzzle, FileCode } from 'lucide-react';
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-24 sm:py-32 lg:py-40">
          <div className="text-center animate-fade-in-up">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              Build with{' '}
              <span className="gradient-text">Ika</span>
            </h1>

            {/* Subtitle */}
            <p className="mx-auto mt-6 max-w-2xl text-lg text-fd-muted-foreground sm:text-xl">
              The documentation for Ika - enabling secure, decentralized multi-chain
              interactions through dWallets and 2PC-MPC cryptography.
            </p>
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
              <div>
                ...
                <p className="mt-4 text-fd-muted-foreground">
                  Install the Ika SDK and start building multi-chain applications
                  with dWallets in minutes.
                </p>
                <div className="mt-6">
