...
Use [Future Signing](/docs/move-integration/protocols/future-signing-protocol) when:
...
- Learn about [Future Signing](/docs/move-integration/protocols/future-signing-protocol) for two-phase signing
- See the [Bitcoin Multisig Example](/docs/move-integration/examples/multisig-bitcoin-example) for a complete implementation
