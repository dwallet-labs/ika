...
- See [Signing](/docs/move-integration/protocols/signing-protocol) for how to sign with shared dWallets
- Review [Future Signing](/docs/move-integration/protocols/future-signing-protocol) for two-phase signing patterns
