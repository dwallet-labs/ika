...
Use [Direct Signing](/docs/move-integration/protocols/signing-protocol) when:
...
- Learn about [Key Importing](/docs/move-integration/protocols/key-importing-protocol) for existing private keys
