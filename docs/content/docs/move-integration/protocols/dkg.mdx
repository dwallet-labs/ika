...
- Learn about [Presigning](/docs/move-integration/protocols/presigning-protocol) to prepare for signatures
- See [Signing](/docs/move-integration/protocols/signing-protocol) for creating signatures
