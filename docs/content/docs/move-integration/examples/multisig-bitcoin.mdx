...
- Check [Core Concepts](/docs/move-integration/core-concepts/core-concepts-overview) for fundamentals
- See [Integration Patterns](/docs/move-integration/integration-patterns/integration-patterns-overview) for more patterns
