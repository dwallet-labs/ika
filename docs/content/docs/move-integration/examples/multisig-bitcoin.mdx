...
- Check [Core Concepts](/docs/move-integration/core-concepts/) for fundamentals
- See [Integration Patterns](/docs/move-integration/integration-patterns/) for more patterns
