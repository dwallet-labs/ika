...
- Review [Core Concepts](/docs/move-integration/core-concepts/) for fundamentals
- Check [Integration Patterns](/docs/move-integration/integration-patterns/) for common patterns
