...
If you're building DAOs, smart contracts, or automated systems that need network-controlled signing, consider using a [Shared dWallet](/docs/sdk/ika-transaction/shared-dwallet) instead.
</Callout>
