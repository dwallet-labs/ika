...
1. Learn about the [Coordinator Architecture](/docs/build/move-integration/core-concepts/coordinator-architecture)
2. Understand [Capabilities and Approvals](/docs/build/move-integration/core-concepts/capabilities-and-approvals)
3. Follow the [DKG Protocol](/docs/build/move-integration/protocols/dkg) to create your first dWallet
