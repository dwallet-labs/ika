...
- Learn about [Session Management](/docs/build/move-integration/core-concepts/session-management) for unique operation identifiers
- Understand [Payment Handling](/docs/build/move-integration/core-concepts/payment-handling) for managing fees
