...
<Callout type="info" title="Already Have a Zero-Trust dWallet?">
	...
	See [Converting to Shared](/docs/build/move-integration/protocols/converting-to-shared) for details.
</Callout>
...
- See [Presign Pool Management](/docs/build/move-integration/integration-patterns/presign-pool-management) for managing presigns
- Check the [Bitcoin Multisig Example](/docs/build/move-integration/examples/multisig-bitcoin) for a complete implementation
