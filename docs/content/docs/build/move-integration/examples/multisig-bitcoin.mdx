...
- Check [Core Concepts](/docs/build/move-integration/core-concepts/overview) for fundamentals
- See [Integration Patterns](/docs/build/move-integration/integration-patterns/overview) for more patterns
