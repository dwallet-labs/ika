...
See [Converting to Shared](/docs/build/move-integration/protocols/converting-to-shared) for the complete guide, including:
...
- Learn about [Integration Patterns](/docs/build/move-integration/integration-patterns/overview) for common use cases
- See the [Bitcoin Multisig Example](/docs/build/move-integration/examples/multisig-bitcoin) for a complete implementation
