...
- Learn about [Shared dWallet Contracts](/docs/build/move-integration/integration-patterns/shared-dwallet-contracts) for contract-owned signing
- See [Signing](/docs/build/move-integration/protocols/signing) for how to sign with shared dWallets
- Review [Future Signing](/docs/build/move-integration/protocols/future-signing) for two-phase signing patterns
