...
Use [Direct Signing](/docs/build/move-integration/protocols/signing) when:
...
- Learn about [Key Importing](/docs/build/move-integration/protocols/key-importing) for existing private keys
