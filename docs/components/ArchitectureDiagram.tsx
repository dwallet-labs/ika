...
function NodeBox({ node, isNested = false }: { node: DiagramNode; isNested?: boolean }) {
  ...
  return (
    <div
      className={clsx(
        'border rounded-md px-3 py-2 text-center min-w-[100px]',
        variants[variant]
      )}
    >
      <div className={clsx(
  ...
  return (
    ...
    >
      <div className="text-center mb-3">
        <div className="text-sm font-semibold text-ika-400">
          {layer.title}
        </div>
        {layer.subtitle && (
...
export default function ArchitectureDiagram({
  ...
  return (
    <div className={clsx('my-6', className)}>
      {title && (
        <h3 className="text-base font-semibold text-ika-400 mb-4 italic">
          {title}
        </h3>
      )}
      ...
      layers={[
        {
          ...
          nodes: [
            ...
            { id: 'logic', label: 'Business Logic', subtitle: '(governance, approvals)', variant: 'secondary' },
          ],
        },
        {
          id: 'coordinator',
    ...
    <ArchitectureDiagram
      ...
      layers={[
        ...
        },
        {
          ...
          variant: 'accent',
          nodes: [
            { id: 'unverified', label: 'UnverifiedPresignCap', subtitle: '(store in pool)', variant: 'secondary' },
            { id: 'verified', label: 'VerifiedPresignCap', subtitle: '(ready to use)', variant: 'primary' },
          ],
        },
        {
          id: 'signing',
      ...
      layers={[
        {
          ...
          variant: 'primary',
          nodes: [
            { id: 'unverified', label: 'UnverifiedPresignCap', subtitle: '(store in pool)', variant: 'accent' },
          ],
        },
        {
          id: 'verify',
          ...
          variant: 'accent',
          nodes: [
            { id: 'verified', label: 'VerifiedPresignCap', subtitle: '(ready for signing)', variant: 'primary' },
          ],
        },
        {
          id: 'consume',
      ...
      layers={[
        {
          ...
          nodes: [
            ...
            { id: 'message', label: 'userMessage', subtitle: '(centralized party)', variant: 'muted' },
        ...
        },
        {
          ...
          variant: 'accent',
          nodes: [
            { id: 'cap', label: 'ImportedKeyDWalletCap', variant: 'primary' },
          ],
        },
        {
          id: 'ready',
      ...
      layers={[
        {
          ...
          nodes: [
            ...
            { id: 'cap', label: 'UnverifiedPartialUserSignatureCap', subtitle: '(store with request)', variant: 'secondary' },
          ],
        },
        {
          id: 'governance',
      ...
      layers={[
        {
          ...
          variant: 'primary',
          nodes: [
            { id: 'flow', label: 'request_dwallet_dkg() → DWalletCap', subtitle: '(store permanently)', variant: 'accent' },
          ],
        },
        {
          id: 'presigning',
          ...
          variant: 'secondary',
          nodes: [
            { id: 'request', label: 'request_presign()', subtitle: '→ UnverifiedPresignCap (pool)', variant: 'muted' },
            { id: 'verify', label: 'verify_presign_cap()', subtitle: '→ VerifiedPresignCap (use once)', variant: 'muted' },
          ],
        },
        {
          id: 'signing',
          ...
          variant: 'accent',
          nodes: [
            { id: 'approve', label: 'approve_message()', subtitle: '→ MessageApproval', variant: 'muted' },
        ...
        },
        {
          ...
          variant: 'secondary',
          nodes: [
            { id: 'future', label: 'request_future_sign()', subtitle: '→ UnverifiedPartialUserSignatureCap', variant: 'muted' },
            { id: 'complete', label: 'request_sign_with_partial...', subtitle: 'completes signing', variant: 'muted' },
          ],
        },
      ]}
    />
      ...
      layers={[
        {
          ...
          variant: 'primary',
          nodes: [
            { id: 'presign', label: 'VerifiedPresignCap', subtitle: '(from pool)', variant: 'accent' },
          ],
        },
        {
          id: 'approve',
          ...
          variant: 'accent',
          nodes: [
            { id: 'approval', label: 'MessageApproval', variant: 'primary' },
          ],
        },
        {
          id: 'sign',
          ...
          variant: 'secondary',
          nodes: [
            { id: 'sig', label: 'Signature ID', subtitle: '(network creates signature)', variant: 'accent' },
          ],
        },
      ]}
    />
      ...
      layers={[
        {
          ...
          nodes: [
            ...
            { id: 'store', label: 'Store PartialSigCap', subtitle: 'with request', variant: 'secondary' },
          ],
        },
        {
          id: 'vote',
      ...
      layers={[
        {
          ...
          variant: 'primary',
          nodes: [
            { id: 'dkg', label: 'request_dwallet_dkg_with_public_user_secret_key_share()', variant: 'accent' },
          ],
        },
        {
          id: 'store',
          ...
          variant: 'secondary',
          nodes: [
            { id: 'cap', label: 'DWalletCap', subtitle: '(stored in contract)', variant: 'primary' },
        ...
        },
        {
          ...
          variant: 'accent',
          nodes: [
            { id: 'logic', label: 'Business Logic', subtitle: 'defines when to sign', variant: 'secondary' },
          ],
        },
      ]}
    />
