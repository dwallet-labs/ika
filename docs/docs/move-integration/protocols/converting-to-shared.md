...
:::tip Save Your Secret Key Share
...
- Learn about [Shared dWallet Contracts](/move-integration/integration-patterns/shared-dwallet-contracts) for contract-owned signing
- See [Signing](/move-integration/protocols/signing-protocol) for how to sign with shared dWallets
- Review [Future Signing](/move-integration/protocols/future-signing-protocol) for two-phase signing patterns
