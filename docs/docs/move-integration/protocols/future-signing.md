...
│          │                                                      │
│          ▼                                                      │
│  Store with request (voting, time-lock, etc.)                  │
└─────────────────────────────────────────────────────────────────┘
                            │
...
│          │                                                      │
│          ▼                                                      │
│  Signature ID → Complete signature                             │
└─────────────────────────────────────────────────────────────────┘
```
...
Use [Direct Signing](/move-integration/protocols/signing-protocol) when:
...
- Learn about [Key Importing](/move-integration/protocols/key-importing-protocol) for existing private keys
