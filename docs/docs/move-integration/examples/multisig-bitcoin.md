...
│                                                                 │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────────────────┐ │
│  │ DWalletCap  │  │  Presigns   │  │      Governance         │ │
│  │  (Bitcoin)  │  │  (Taproot)  │  │  - members              │ │
│  └─────────────┘  └─────────────┘  │  - approval_threshold   │ │
│                                    │  - rejection_threshold  │ │
│                                    │  - expiration_duration  │ │
│                                    └─────────────────────────┘ │
│                                                                 │
│  Request Lifecycle:                                             │
│  1. Member creates request with partial signature               │
│  2. Members vote (irrevocable)                                  │
│  3. If approved, anyone can execute                            │
│  4. Signature is created and stored                            │
└─────────────────────────────────────────────────────────────────┘
```
